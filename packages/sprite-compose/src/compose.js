...
export async function composeFullSheet(build, assetRoot, outFile) {
...
export async function extractTile(sheetPath, frameW, frameH, col, row, outFile) {
...
export async function composeAndPreview(build, assetRoot, outDir, name = "sheet") {
...
function resolvePng(root, variant) {
